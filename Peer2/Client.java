...
public class Client extends Thread
{
    ...
    {         
            ...
            b1 = false;
            System.out.println("Received connection from port: " +port+"for file "+fName);
            }
            catch(Exception e)
            {
...
//        chunkSizeList=readChunkName.readFileName("Peer1/filesize.txt");
...
//        chunkSizeArray=chunkSizeList.toArray(chunkSizeArray);
    	...
    	{
    		dOut.writeUTF("Peer3FileSplit/"+fName);	
    	}
            ...
            if(msgFromServer.compareTo("AllSet")==0)
            {
                ...
                File f=new File("Peer2FileSplit/"+fName);
