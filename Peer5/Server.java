...
public class Server
{
    public static void main(String args[]) throws Exception
    {
    	...
    	*/
        ...
        uploadFileList = readChunkName.readFileName("src/Peer5/initialchunks.txt");
        ...
        chunkFileList = readChunkName.readFileName("src/Peer5/fileparts.txt");
        ...
        try{
        System.out.println("I am a peer acting as a server on " + peerPort+" and I am sending files to peer with port at "+ downloadPeerPort);
        while(true)
        {
...
class Handler extends Thread
{
    ...
    {    
        ...
        chunkSizeList=readChunkName.readFileName("src/Peer5/filesize.txt");
        ...
        while(true){
            ...
            if(f.exists()&&((int)f.length()==(Integer.parseInt(chunkSizeArray[0]))||((int)f.length()==Integer.parseInt(chunkSizeArray[1])))){
            	...
            	File file = new File("Peer5FileSplit/");
