...
public class Server
{
    public static void main(String args[]) throws Exception
    {
    	...
    	*/
        ...
        uploadFileList = readChunkName.readFileName("src/Peer3/initialchunks.txt");
        ...
        chunkFileList = readChunkName.readFileName("src/Peer3/fileparts.txt");
    ...
    {    
        ...
        while(true){
            ...
            if(f.exists()&&((int)f.length()==(Integer.parseInt(chunkSizeArray[0]))||((int)f.length()==Integer.parseInt(chunkSizeArray[1])))){
            	File file = new File("Peer3FileSplit/");
